...
namespace EccentricityACI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Calculate AlphaNew (Piscesa et. al. (2016) ACI Structural Journal and Elsevier Composite Structure)
            alphanew = Pow(fcc - fr, 2.0) - fc * fc;
            alphanew /= m * fr * fc;
            ...
            r = 1.0 - 1.5 * rho * rho / (fc * fc) - m * kesi * alphanew / (Sqrt(3.0) * fc);
